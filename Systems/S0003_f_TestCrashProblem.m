%% Function: Bottom-up Mapping of Problem S0003_f_TestCrashProblem
% Template generated automatically
% 
% Inputs:
%     - x: Design Variables - Array size: [6,sample size]
%         -- F_2: Force applied in the second stage of crash [N] - Bounds: [0,1e+06]
%         -- m: Total mass of the vehicle [kg] - Bounds: [1500,2500]
%         -- F_1: Force applied in the first stage of crash [N] - Bounds: [0,1e+06]
%         -- v_0: Vehicle speed at the start of the crash [m/s] - Bounds: [0,100]
%         -- d1c: Critical displacement in the first stage of crash [m] - Bounds: [0,0.6]
%         -- d2c: Critical displacement in the second stage of crash [m] - Bounds: [0,0.6]
...
function qoi = S0003_f_TestCrashProblem(x,param)
    %% Initialization

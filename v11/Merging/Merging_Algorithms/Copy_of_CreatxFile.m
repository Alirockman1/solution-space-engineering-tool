function Matlabx = CreatxFile (System_Name_CSV,SampleSize,Folder_Design_Problems,Folder_Systems,Folder_Database,Folder_Merging_Algorithms)
%Description :
...
%Matlabx : Name of the final Matlab file for the XRay tool
    ...
    for i = 1:NOutput
        ...
        fprintf(MatlabWriter,'%s\n\t\t\t\t',"'" + Output(1,i) + "', '" + TypeOfTheVar + "', '" + ColorOfTheVar +"', " + "0" + ", " + "200" + ", " + "1" + ",'" + DescriptionVar + " is violated'" + ";...");
    end
    fprintf(MatlabWriter,'%s\n\n\t\t\t',"};");
    ...
    fprintf(MatlabWriter,'%s\n\t\t\t',"% Paths (WARNING : This creat X files that are adapted for 1 saving position !)");
    fprintf(MatlabWriter,'%s\n\t\t\t',"addpath(" + Folder_Database + ");");
    fprintf(MatlabWriter,'%s\n\t\t\t',"addpath(" + Folder_Systems + ");");
        %Function
    fprintf(MatlabWriter,'%s\n\t\t\t',"% Function :");
    ...
    fprintf(MatlabWriter,'%s\n',"end");
    %end classdef
    fprintf(MatlabWriter,'%s',"end");
    %closing the writing
    fclose(MatlabWriter);
    
   	%final position in Folder_Design_Problems
    copyfile(Matlabx,Folder_Design_Problems);
    cd(Folder_Systems);
    delete (Matlabx);

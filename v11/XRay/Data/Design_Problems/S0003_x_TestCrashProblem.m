%% S0003_x_TestCrashProblem.m

% Template generated automatically
% 
classdef S0003_x_TestCrashProblem < handle
    properties
		%--------------------------------------------------
		...
		save_as = 'S0003_x_TestCrashProblem.mat';
	end

    methods
		function obj = S0003_x_TestCrashProblem()
			addpath('Data\Save');
			try
				load(obj.save_as);
				obj = OBJ;

...
classdef S0009_x_cfk3d < handle
    properties
		...
		save_as = 'S0009_x_cfk3d.mat';
	end

    methods
		function obj = S0009_x_cfk3d()
			addpath('Data\Save');
			try
				load(obj.save_as);
				obj = OBJ;
               ...
               quantities_of_interest = {...
                   'f','mm',[0.188235,0.329412,0.588235],-Inf,3,1,'Deflection is too high';...
                   'S_f','',[1,0.752941,0],-Inf,0.3,1,'Safety factor violated';...
                   };
               % Cell to structure

...
%   limitations under the License.
    ...
    methods
        ...
        %   BOTTOMUPMAPPINGCONTINUOUSVARIABLES(...,COMPONENTINDEX,...) additionally 
        %   returns the discretized bounds, initial design, and component indices 
        %   adapted for the continuous representation.
        %

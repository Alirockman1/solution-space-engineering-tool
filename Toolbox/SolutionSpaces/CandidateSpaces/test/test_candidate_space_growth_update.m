%TEST_CANDIDATE_SPACE_GROWTH_UPDATE Test candidate space growth update
%   TEST_CANDIDATE_SPACE_GROWTH_UPDATE tests the growth update of the 
%   candidate space.
...
%% function call
%
systemFunction = @(x) [sqrt(x(:,1).^2 + x(:,2).^2 + x(:,3).^2)];
...
figure;
hold all;
candidateSpaceInitial(1).plot_candidate_space(gca,'EdgeColor',color_palette_tol('cyan'),'FaceColor','none');
...
hold all;
candidateSpaceInitial(1).plot_candidate_space(gca,'EdgeColor',color_palette_tol('cyan'),'FaceColor','none');
candidateSpaceGrown(1).plot_candidate_space(gca,'EdgeColor',color_palette_tol('green'),'FaceColor','none');
...
figure;
hold all;
candidateSpaceTrimmed(1).plot_candidate_space(gca,'EdgeColor',color_palette_tol('cyan'),'FaceColor','none');

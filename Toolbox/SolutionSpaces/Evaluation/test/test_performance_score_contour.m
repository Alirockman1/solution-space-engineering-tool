%TEST_PERFORMANCE_SCORE_CONTOUR Performance score contour plot
%   TEST_PERFORMANCE_SCORE_CONTOUR plots the performance score contour plot.
...
deficit1 = design_measure_to_deficit(...
    quantityOfInterest1,...
    quantityOfInterestLowerLimit(1),...
    quantityOfInterestUpperLimit(1));
...
deficitGrid = design_measure_to_deficit(...
    [quantityOfInterest1Grid(:),quantityOfInterest2Grid(:)],...
    quantityOfInterestLowerLimit,quantityOfInterestUpperLimit);

...
%   limitations under the License.
    ...
    methods
        ...
        %   See also BottomUpMappingBase, evaluate.
            ...
            if(~isa(bottomUpMapping,'BottomUpMappingBase'))
                error('DesignEvaluatorBottomUpMapping:InvalidBottomUpMapping',...
                    'Bottom-up mapping must be a BottomUpMappingBase object, a function handle, or a string.');
            end

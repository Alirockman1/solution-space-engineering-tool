...
%   limitations under the License.
    ...
    methods
        ...
        %   See also evaluate.
            ...
            obj.PerformanceDeficitDefaultValue = parser.Results.PerformanceDeficitDefaultValue;
            obj.PhysicalFeasibilityDeficitDefaultValue = parser.Results.PhysicalFeasibilityDeficitDefaultValue;
        end
        ...
        %   See also DesignFastForward.
            ...
            if(~isempty(obj.ModelPerformance))
                [performanceDeficit,performanceOutput] = obj.ModelPerformance.predict_design_deficit(designSample);
            ...
            if(~isempty(obj.ModelPhysicalFeasibility))
                [physicalFeasibilityDeficit,physicalFeasibilityOutput] = obj.ModelPhysicalFeasibility.predict_design_deficit(designSample);

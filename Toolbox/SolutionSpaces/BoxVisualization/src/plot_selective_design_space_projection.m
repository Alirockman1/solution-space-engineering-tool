...
%       the plots. Default: @sampling_random.
...
%
%   See also sso_box_stochastic, evaluate_selective_design_space_projection,
...
%   limitations under the License.
    ...
    evaluationFields = {...
        'SamplingMethod',...
        'SamplingOptions',...
        'NumberSamplesPerPlot',...
        'MarkerColorsCriterion',...
        'PerformanceMeasureLowerLimit',...
        'PerformanceMeasureUpperLimit',...
        'PhysicalFeasibilityLowerLimit',...
        'PhysicalFeasibilityUpperLimit',...
        'PerformanceActiveStatus',...
        'PhysicalFeasibilityActiveStatus'};
    ...
    plotFields = {...
        'AxesLabels',...
        'MarkerColorsViolatedRequirements',...
        'PlotIntervals',...
        'PlotOptionsGood',...
        'PlotOptionsBad',...
    ...
    for j=1:size(desiredPairs,1)
        ...
        hold all;
        designTypeHandle = plot_design_space_projection_axis(figureElementHandle.IndividualPlots(j),plotData(j),plotOptions{:});

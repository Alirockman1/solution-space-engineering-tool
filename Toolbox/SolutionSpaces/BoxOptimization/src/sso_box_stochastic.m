    ...
    while((~hasConvergedExploration) && (iExploration<=options.MaxIterExploration))
        ...
        if(nAcceptable==0 || nUseful==0 || nAcceptableUseful==0 || (options.UseAdaptiveGrowthRate && purity<options.MinimumPurityReset))
            ...
            if(isOutputOptimizationData)
                ...
                optimizationData.IterationData(iLog) = struct(... 
                    ...
                    'MeasureBeforeTrim',measureGrown,...
                    'MeasureAfterTrim',measureTrimmed,...
                    'IntervalSizeBeforeTrim',candidateBoxGrown(2,:) - candidateBoxGrown(1,:),...
                    'IntervalSizeAfterTrim',candidateBox(2,:) - candidateBox(1,:),...
                    ... % system data
                    ...
                    ... % trimming data
                    'CandidateBoxBeforeTrim',ternary(options.SaveIterationAllData,candidateBoxGrown,[]),...
                    'CandidateBoxAfterTrim',ternary(options.SaveIterationAllData,candidateBox,[]),...
                    ... % time data
        ...
        if(isOutputOptimizationData)
            ...
            optimizationData.IterationData(iLog) = struct(...
                ...
                'MeasureAfterTrim',measureTrimmed,...
                'IntervalSizeBeforeTrim',candidateBoxGrown(2,:) - candidateBoxGrown(1,:),...
                'IntervalSizeAfterTrim',candidateBoxTrimmed(2,:) - candidateBoxTrimmed(1,:),...
                ... % system data
                'EvaluatedDesignSamples',ternary(options.SaveIterationAllData,designSample,[]),...
                'EvaluationOutput',ternary(options.SaveIterationAllData,outputEvaluation,[]),...
                ... % problem data
                ...
                ... % trimming data
                'CandidateBoxBeforeTrim',ternary(options.SaveIterationAllData,candidateBoxGrown,[]),...
                'CandidateBoxAfterTrim',ternary(options.SaveIterationAllData,candidateBoxTrimmed,[]),...
                ... % time data
                'TimeElapsedAdaptGrowthRate',timeElapsedAdaptGrowth,...
                'TimeElapsedGrow',timeElapsedGrow,...
                'TimeElapsedGenerate',timeElapsedGenerate,...
    ...
    while((~convergenceConsolidation) && (iConsolidation<=options.MaxIterConsolidation))
        ...
        if(isOutputOptimizationData)
            ...
            optimizationData.IterationData(iLog) = struct(...
                ...
                'NumberAcceptableDesigns',nAcceptable,...
                'NumberUsefulDesigns',nUseful,...
                'MeasureBeforeTrim',measure,...
                'MeasureAfterTrim',measureTrimmed,...
                'IntervalSizeBeforeTrim',candidateBox(2,:) - candidateBox(1,:),...
                'IntervalSizeAfterTrim',candidateBoxTrimmed(2,:) - candidateBoxTrimmed(1,:),...
                ... % system data
                'EvaluatedDesignSamples',ternary(options.SaveIterationAllData,designSample,[]),...
                'EvaluationOutput',ternary(options.SaveIterationAllData,outputEvaluation,[]),...
                ...
                'IsUseful',ternary(options.SaveIterationAllData,isUseful,[]),...
                ... % trimming data
                'CandidateBoxBeforeTrim',ternary(options.SaveIterationAllData,candidateBox,[]),...
                'CandidateBoxAfterTrim',ternary(options.SaveIterationAllData,candidateBoxTrimmed,[]),...
                ... % time data

function update_design_space_lower_bound_given_textbox_input(src, event, dataManager, iVariable)
%UPDATE_DESIGN_SPACE_LOWER_BOUND_GIVEN_TEXTBOX_INPUT Update design space lower bound from textbox
%   UPDATE_DESIGN_SPACE_LOWER_BOUND_GIVEN_TEXTBOX_INPUT is a callback
%   function that updates the design space lower bound for a design variable
...
%
%   UPDATE_DESIGN_SPACE_LOWER_BOUND_GIVEN_TEXTBOX_INPUT(SRC, EVENT,
%   DATAMANAGER, IVARIABLE) is called when the user edits the design space
%   lower bound textbox for a design variable.
%
%   Inputs:
%       - SRC : uieditfield
...
%
%   See also BoxXRayOperations.update_gui_design_space_lower_bound,
%   update_design_space_upper_bound_given_textbox_input.
...
%   limitations under the License.
    ...
    BoxXRayOperations.update_gui_design_space_lower_bound(dataManager, iVariable, newValue);
end
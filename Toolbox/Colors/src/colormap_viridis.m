...
%	one of the color schemes from 'viridis'. Originally intended for R, but 
...
%		Marco, Scherer, Cédric (2024). viridis(Lite) - Colorblind-Friendly Color 
%		Maps for R. doi:10.5281/zenodo.4679423, viridis package version 0.6.5, 
...
%   limitations under the License.
	...
	folderPath = replace(erase(filePath,mfilename),'\','/');

	filename = sprintf('%sviridis-rgb/%s-rgb.csv',folderPath,lower(options.Map));
